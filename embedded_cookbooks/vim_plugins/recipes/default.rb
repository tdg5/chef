...
include_recipe 'vim_plugins::vim_testkey'
include_recipe 'vim_plugins::vim_go'
include_recipe 'vim_plugins::vim_endwise'
include_recipe 'vim_plugins::vim_clojure_static'
include_recipe 'vim_plugins::vim_fireplace'
include_recipe 'vim_plugins::vim_niji'
include_recipe 'vim_plugins::vim_autoclose'
